...
void functionTwo()
{
	...
	bool functionThree()
	{
		...
		int main()
		{
			...
			getline(cin, kata2);
			cout << kata1 << " adalah pemain1 jadi dia akan bermain terlebih dahulu \n";
			cout << kata2 << " adalah pemain2 jadi dia akan bermain kedua \n";
			...
			{
				cout << kata2 << " adalah PEMENANGNYA !!!" << endl;
			}
			else if(token == 'O' && tie == false)
			{
				cout << kata1 << " adalah PEMENANGNYA !!!" << endl; 
			}
			else
			{
